...
<div class="container-fluid1">
    ...
    <div class="boxContent">
        <div class="left" id="left" @click="loadAndJump()">
            <div style="background-image: linear-gradient(rgba(0,0,0,0), rgba(0,0,0,1));opacity:0.7;z-index:2; position:relative; width: 100%;height:76vh; margin-top: 0vh;">
...
export default {
    ...
    methods: {
        ...
        reFilter() {
            ...
            //     elements.style.backgroundImage = "url('../assets/r4.jpg')";
            //     var ubox = document.getElementById("ubox");
            //     console.log(ubox)
            //     ubox.style.backgroundImage = "url('../assets/r4.jpg')";
            // }
        }
    },
};
